...
def is_local_endpoint(base_url: str) -> bool:
    ...
    if host in _LOCAL_HOSTS or host.endswith(_CONTAINER_LOCAL_SUFFIXES) or host.endswith(".ts.net") or host.endswith(".local") or (host and "." not in host and ":" not in host):
        return True
    try:
