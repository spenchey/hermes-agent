...
- A member turn owns the room for at most **three minutes**. Work that is still running continues in the member session; Desktop checks it every 5 minutes for the first hour, every 15 minutes through hour 4, every 30 minutes through hour 12, and hourly until the 24-hour cutoff. It posts the completed reply back into the same room and thread. Persisted pending markers preserve the cooldown age and let another Desktop resume the check after reconnecting or reopening the room.
